...
aes_key_hi:
    ...
    lea .Laeskeygenret1(%rip), %rax
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret1:
    movdqa %xmm1, %xmm5
    aeskeygenassist $2, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret2 - .Laeskeygenret1)
    addb $nextr, %al
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret2:
    movdqa %xmm1, %xmm6
    aeskeygenassist $4, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret3 - .Laeskeygenret2)
    addb $nextr, %al
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret3:
    movdqa %xmm1, %xmm7
    aeskeygenassist $8, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret4 - .Laeskeygenret3)
    addb $nextr, %al
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret4:
    movdqa %xmm1, %xmm8
    aeskeygenassist $16, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret5 - .Laeskeygenret4)
    addb $nextr, %al
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret5:
    movdqa %xmm1, %xmm9
    aeskeygenassist $32, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret6 - .Laeskeygenret5)
    addb $nextr, %al
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret6:
    movdqa %xmm1, %xmm10
    aeskeygenassist $64, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret7 - .Laeskeygenret6)
    addb $nextr, %al
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret7:
    movdqa %xmm1, %xmm11
    aeskeygenassist $0x80, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret8 - .Laeskeygenret7)
    addb $nextr, %al
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret8:
    movdqa %xmm1, %xmm12
    aeskeygenassist $0x1b, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret9 - .Laeskeygenret8)
    addw $nextr, %ax
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret9:
    movdqa %xmm1, %xmm13
    aeskeygenassist $0x36, %xmm1, %xmm2
    .set nextr, (.Laeskeygenret10 - .Laeskeygenret9)
    addw $nextr, %ax
    jmp .Laes_gctr_linear_prepare_roundkey_128
.Laeskeygenret10:
    movdqa %xmm1, %xmm14
